                        ...
                        {Array.isArray(projects) &&
                            projects.map((project) => (
                                ...
                                >
                                    ...
                                    />
                                    <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-black/40 z-0">
                                    ...
                                    <a
                                     ...
                                     className="absolute z-50 px-4 py-2 text-xl font-semibold text-white transition rounded-lg bottom-2 right-2 hover:bg-red-500" >
                                         See More 
                                         </a>
                                </SwiperSlide>
                            ))}
